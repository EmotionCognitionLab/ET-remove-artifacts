...
h.ax(1).XLabel.FontSize = 8;
h.ax(1).YLabel.FontSize = 8;
...
h.ax(2).XLabel.FontSize = 8;
h.ax(2).YLabel.FontSize = 8;
h.ax(2).Title.FontSize = 10;
h.ax(2).FontSize = 8;
...
h.pn(1).ed(1) = uicontrol('Style','Edit',...
    ...
    'HorizontalAlignment','Center',...
    'FontSize',10,...
    'Position',[0.85 0.3 0.1 0.45]);
h.pn(1).tx(2) = uicontrol('Style','Text',...
    'Parent',h.pn1,...
    'Units','Normalized',...
    'HorizontalAlignment','Left',...
    'FontSize',10,...
    'Position',[0.75 0.3 0.10 0.4],...
    'String','Index');
...
h.pn(2).rb(2) = uicontrol('Style','RadioButton',...
    'Parent',h.pn2,...
    'Units','Normalized',...
    'Position',[0.05 0.45 0.125 0.125],...
...
h.pn(2).rb(3) = uicontrol('Style','RadioButton',...
    'Parent',h.pn2,...
    'Units','Normalized',...
    'Position',[0.05 0.25 0.125 0.125],...
...
h.pn(2).tx(5) = uicontrol('Style','Text',...
    ...
    'HorizontalAlignment','Left',...
    'FontSize',9,...
    'Position',[0.55 0.76 0.6 0.2],...
    'String','Pupil Plot');
h.pn(2).rb(4) = uicontrol('Style','RadioButton',...
    'Parent',h.pn2,...
    'Units','Normalized',...
    'Position',[0.55 0.65 0.125 0.125],...
    'Tag','Original',...
    'Value',1,...
    'Callback',@rb_call);
h.pn(2).rb(5) = uicontrol('Style','RadioButton',...
    'Parent',h.pn2,...
    'Units','Normalized',...
    'Position',[0.55 0.45 0.125 0.125],...
    'Tag','Reconstructed',...
    'Value',1,...
    'Callback',@rb_call);
h.pn(2).rb(6) = uicontrol('Style','RadioButton',...
    'Parent',h.pn2,...
    'Units','Normalized',...
    'Position',[0.55 0.25 0.125 0.125],...
...
h.pn(2).rb(7) = uicontrol('Style','RadioButton',...
    'Parent',h.pn2,...
    'Units','Normalized',...
    'Position',[0.55 0.05 0.125 0.125],...
