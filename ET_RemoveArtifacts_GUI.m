...
%resizes the elements according to figure dimensions
    ...
    try
        ...
        h.pn2.Position = [panels_x, figure_handle.Position(4)-250, panels_w, 160];
        h.pn3.Position = [panels_x, figure_handle.Position(4)-450, panels_w/2-5, 200];
        h.pn4.Position = [panels_x+h.pn3.Position(3)+10, figure_handle.Position(4)-450, panels_w/2-5, 200];
        h.pn5.Position = [panels_x, figure_handle.Position(4)-580, panels_w, 120];
    catch
